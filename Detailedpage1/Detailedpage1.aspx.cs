...
{
    public partial class Detailedpage1 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            String URLString = "https://opendata.fmi.fi/wfs?service=WFS&version=2.0.0&request=getFeature&storedquery_id=fmi::forecast::hirlam::surface::point::timevaluepair&place=lahti&parameters=temperature,windspeedms&";
            ...
            this.feellike = 13.12 + 0.6215 * this.temperature
                - 11.37 * Math.Pow(this.wind, 0.16)
                + 0.3965 * this.temperature * Math.Pow(this.wind, 0.16);
