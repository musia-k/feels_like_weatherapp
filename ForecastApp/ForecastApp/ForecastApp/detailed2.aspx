<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="detailed2.aspx.cs" Inherits="ForecastApp.detailed2" %>
        ...
        <div class="block">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="container">
                    <div class="city"> <h1>Helsinki</h1></div>
                    <div>
                    ...
                    <div class="ROW">
                        <but type="submit" class="button" onclick="window.location.href='../welcome.aspx'">
