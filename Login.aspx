<%@ Page Language="C#" Async="true" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="ProjFeels.Login" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div class="log">   
                    ...
                    <asp:TextBox ID="TextBox1" runat="server" CssClass="textbox1" ></asp:TextBox> <br />   
                    <asp:Label ID="Label3" runat="server" Text="Password" CssClass="lab2" ></asp:Label> <br />
                    <asp:TextBox ID="TextBox2" runat="server" CssClass="textbox2" ></asp:TextBox> <br />  
                    <br />
                    <div class="row_3">
                        <asp:HyperLink ID="HyperLink1" NavigateUrl="~/Registration.aspx" runat="server">Create an account</asp:HyperLink>
                        <a href="#">Forgot password?</a>
                    </div>
                    <asp:Button ID="Button1" runat="server" Height="34" Width="90" Text="Log In" OnClick="Button1_Click" CssClass="bttn" />
                </div>
        </form>
<p> OR </p>
            <div class="row_5"> 
