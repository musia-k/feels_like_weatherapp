<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Detailedpage.aspx.cs" Inherits="Detailedpage.Detailedpage" %>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="group1">
                        ...
                        <div class="row3">
                            <span class="Wind">sw 4m/s</span>
                            <span class="line3"></span>
                            <span class="Feellike">9°</span>
                        </div>
                        <div class="row4">
                            <span class="Visibility">9,7km</span>
                            <span class="line4"></span>
                            <span class="UV">1</span>
                        </div>
                    </div>
                    <div class="group2">
                        <div class="row5">
